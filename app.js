...
// session store (fixed placement of touchAfter)
const store = MongoStore.create({
  mongoUrl: dburl,
...
// mount routers — ORDER MATTERS: mount your routers BEFORE 404 handler
app.use("/listings", listingrouter);
app.use("/listings/:id/reviews", reviewrouter);
app.use("/", userRouter);
app.use("/", indexRouter);
...
// start server (after handlers defined)
